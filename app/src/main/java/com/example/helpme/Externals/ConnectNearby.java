...
public class ConnectNearby {
    ...
    private static class ReceiveDataPayloadListener extends PayloadCallback {
        ...
        public void onPayloadReceived(String endpointId, Payload payload) {
            ...
            Toast debug;
            debug = Toast.makeText( mainActivity,String.valueOf(receivedBytes),Toast.LENGTH_LONG);
        ...
        public void onPayloadTransferUpdate(String endpointId, PayloadTransferUpdate update) {
            ...
            Log.d(Constants.NEARBY_LOG, "onPayloadTransferUpdate: ");
        }
    }
    ...
    private static final EndpointDiscoveryCallback endpointDiscoveryCallback =
            new EndpointDiscoveryCallback() {
                ...
                public void onEndpointFound(String endpointId, DiscoveredEndpointInfo info) {
                    ...
                    requestedPeerEPIs.add(endpointId);
